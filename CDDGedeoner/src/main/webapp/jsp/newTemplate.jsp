<%@page import="org.cdd.common.PCMConstants"%>
			           ...
			           <%if (profile.contentEquals("ADMINISTRADOR") || profile.contentEquals("CONSULTOR_UTE")){ %>
				          <li class="nav-item dropdown">
				             ...
				             <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
					             ...
					             <li><a class="dropdown-item" href="dispatch?event=GestionAgrupaEstudios.query">Agrupaciones estudios</a></li>
 				             	 <li><a class="dropdown-item" href="dispatch?event=GestionSubdirecciones.query">Subdirecciones</a></li>
	  ...
	  <%if (request.getAttribute("container") != null) {	%>
	  		<%if ( !event.contentEquals("Authentication.submitForm") && (profile == null || profile.contentEquals("")) ) { %>
	  			<div style="position: relative;top: 2px;left: 1px;">
	  				Sesión expirada: vuelva a autenticarse desde la home
	  			</div>
	  		<%}else {%>
