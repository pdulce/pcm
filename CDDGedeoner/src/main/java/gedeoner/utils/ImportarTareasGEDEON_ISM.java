...
public class ImportarTareasGEDEON_ISM extends ImportarTareasGEDEON{
	
	public ImportarTareasGEDEON_ISM(IDataAccess dataAccess_) {
		super(dataAccess_);
	}
	...
	public static void main(String[] args){
		try{
			...
			final ImportarTareasGEDEON_ISM importadorGEDEONes = new ImportarTareasGEDEON_ISM(dataAccess_);
