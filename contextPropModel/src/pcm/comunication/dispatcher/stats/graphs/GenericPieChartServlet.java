...
import pcm.comunication.dispatcher.stats.GenericStatsServlet;
			...
			while (ite.hasNext()) {
				...
				if (registroPorCategoria.getEntityDef().getName().equals(agrupacionInterna.getEntityDef().getName())) {
					...
					if (registroPorCategoria.getValue(agrupacionInterna.getName()) == null) {
						...
						//recorremos cada subtotal, y seteamos el valor de la agrupación (valorParaCategoria1EnEsteRegistroAgregado) con el subagregado de la misma
