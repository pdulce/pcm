...
public class ContextApp implements Serializable {
	...
	private String uri, appTitle, entitiesDictionary, dataSourceAccess, dSourceImpl, datasourceFactoryImpl, dbPreffix, resourceName,
	...
	public ContextApp(String appMetamodel_) {
		...
		this.appMetamodel = appMetamodel_;
	}

	public String getAppMetamodel() {
