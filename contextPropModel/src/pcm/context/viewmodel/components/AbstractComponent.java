...
import pcm.context.data.FieldValue;
import pcm.context.data.IFieldValue;
import pcm.context.data.SerializedValues;
...
public abstract class AbstractComponent implements IViewComponent, Serializable {
	...
	protected ContextApp appContext;
	...
	public final ContextApp getAppContext() {
		return this.appContext;
	}

	protected final void setAppContext(final ContextApp appContext) {
	...
	public final List<FieldViewSet> getFieldViewSets() {
		try {
			...
			BasePCMServlet.log.log(Level.SEVERE, InternalErrorsConstants.FIELDVIEWSETS_ERROR, exc);
			return null;
		}
	}
	...
	public final void refreshValues(final HashMap<String, IFieldValue> valuesMemo) {
		try {
			...
			BasePCMServlet.log.log(Level.SEVERE, InternalErrorsConstants.FIELDVIEWSETS_REFRESH_ERROR, exc);
		}
	}
	...
	public final SerializedValues getSerializedValues() {
		try {
			...
			BasePCMServlet.log.log(Level.SEVERE, InternalErrorsConstants.FIELDVIEWSETS_SERIALIZED_ERROR, exc);
			return null;
		}
	}
	...
	protected final IFieldValue getValueOfField(final String qualifiedName, final int recordPosition) {
		try {
			...
			BasePCMServlet.log.log(Level.SEVERE, InternalErrorsConstants.FIELDVIEWSETS_VALUE_ERROR, exc);
		}
	...
	protected final IFieldView searchFieldView(final String qname) {
		try {
			...
			BasePCMServlet.log.log(Level.SEVERE, InternalErrorsConstants.FIELDVIEWSETS_ALLVALUES_ERROR, exc);
			return null;
		}
	}
