...
public interface PCMConstants {
	...
	public static final String ID_PAGINACION = "paginacion", LANGUAGE = "language", ENTITIES_MODEL = "entitiesDictionary",
			...
			APPLICATION_TITLE = "appTitle", APP_CONTEXT = "appContext", APP_DICTIONARY = "appDictionary", ENTITY_NODENAME = "entity",
			ROW_LABEL = "row", JPG_FORMAT = "jpg",
			XML_EXTENSION = ".xml", TITLE = "#TITLE#", CSS = "#CSS#", LOGO = "#LOGO#", FOOT = "#FOOT#", MENU_ITEMS = "#MENU_ITEMS#",
			TREE = "#TREE#", BODY = "#BODY#", FILE_INTERNAL_URI_PARAM = "filePath", FILE_UPLOADED_PARAM = "fileUploaded",
