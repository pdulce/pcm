...
import org.cdd.service.component.factory.BodyContainerFactory;
				...
				for (final IViewComponent paginationGrid : subcomps) {
					...
					while (iteForms.hasNext()) {
						...
						if (formOfContainer.getUniqueName().equals(idOfForm) && !idFormsPainted.contains(idOfForm)) {
							...
							/*if (datamap.getAttribute(PCMConstants.CHARGE_FILTER_BY) != null) {
								datamap.removeAttribute(PCMConstants.CHARGE_FILTER_BY);								
							}*/
