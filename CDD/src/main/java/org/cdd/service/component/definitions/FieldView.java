...
import org.cdd.service.component.definitions.validator.ByteValidator;
import org.cdd.service.component.definitions.validator.DateValidator;
import org.cdd.service.component.definitions.validator.DoubleValidator;
import org.cdd.service.component.definitions.validator.IntegerValidator;
import org.cdd.service.component.definitions.validator.LongValidator;
import org.cdd.service.component.definitions.validator.RelationalAndCIFValidator;
import org.cdd.service.component.definitions.validator.StringValidator;
...
import org.cdd.service.dataccess.definitions.ILogicTypes;
...
public class FieldView implements IFieldView, Serializable {
	...
	private void setCommonAttrs(final Element nodeField) {
		...
		if (optionValuesSet.getLength() == 1) {
			...
			if (optionSet.hasAttribute(FieldViewSet.ENTITYMODEL_ATTR)) {
				final String entityOptionsName = optionSet.getAttribute(FieldViewSet.ENTITYMODEL_ATTR);
