...
public class ExtractorEsfuerzoPorPeticion extends GeneradorPresentaciones{
	...
	public ExtractorEsfuerzoPorPeticion(final boolean modoEjecucion, final String url_, final String entitiesDictionary){
	...
	public static void main(String[] args){
		try{
			...
			final ExtractorEsfuerzoPorPeticion extractorEffort = new ExtractorEsfuerzoPorPeticion(modoEjecucionLocal, url_, entityDefinition);
