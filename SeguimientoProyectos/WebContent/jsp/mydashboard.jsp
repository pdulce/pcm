<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<table>
		<tr>
			<td><jsp:include page="${containerJSP_11}"></jsp:include></td>
			<td><jsp:include page="${containerJSP_12}"></jsp:include></td>
		</tr>	
		<tr>
			<td><jsp:include page="${containerJSP_21}"></jsp:include></td>
